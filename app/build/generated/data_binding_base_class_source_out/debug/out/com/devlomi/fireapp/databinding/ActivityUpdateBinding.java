...
public final class ActivityUpdateBinding implements ViewBinding {
  ...
  private ActivityUpdateBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnUpdate,
      @NonNull ImageView imgUpdate, @NonNull TextView tvUpdate) {
  ...
  public static ActivityUpdateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUpdateBinding((ConstraintLayout) rootView, btnUpdate, imgUpdate, tvUpdate);
    }
