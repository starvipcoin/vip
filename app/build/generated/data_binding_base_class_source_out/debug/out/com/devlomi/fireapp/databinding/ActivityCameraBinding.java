...
public final class ActivityCameraBinding implements ViewBinding {
  ...
  private ActivityCameraBinding(@NonNull FrameLayout rootView, @NonNull JCameraView jcameraview) {
  ...
  public static ActivityCameraBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCameraBinding((FrameLayout) rootView, jcameraview);
    }
