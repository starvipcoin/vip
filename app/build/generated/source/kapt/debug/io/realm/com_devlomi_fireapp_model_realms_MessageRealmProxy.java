...
public class com_devlomi_fireapp_model_realms_MessageRealmProxy extends com.devlomi.fireapp.model.realms.Message
    ...
    static com_devlomi_fireapp_model_realms_MessageRealmProxy newProxyInstance(BaseRealm realm, Row row) {
    ...
    public static com.devlomi.fireapp.model.realms.Message copy(Realm realm, MessageColumnInfo columnInfo, com.devlomi.fireapp.model.realms.Message newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        com_devlomi_fireapp_model_realms_MessageRealmProxyInterface unmanagedSource = (com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) newObject;
        ...
        io.realm.com_devlomi_fireapp_model_realms_MessageRealmProxy managedCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, com.devlomi.fireapp.model.realms.Message object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.typeColKey, objKey, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$type(), false);
        ...
        String realmGet$partialText = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$partialText();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.messageStatColKey, objKey, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$messageStat(), false);
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.downloadUploadStatColKey, objKey, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$downloadUploadStat(), false);
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.voiceMessageSeenColKey, objKey, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$voiceMessageSeen(), false);
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isForwardedColKey, objKey, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$isForwarded(), false);
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isGroupColKey, objKey, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$isGroup(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isBroadcastColKey, objKey, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$isBroadcast(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isSeenColKey, objKey, ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$isSeen(), false);

        RealmList<java.lang.String> broadcastUidsList = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$broadcastUids();
        ...
        String realmGet$encryptionType = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$encryptionType();
        ...
        String realmGet$uri = ((com_devlomi_fireapp_model_realms_MessageRealmProxyInterface) object).realmGet$uri();
